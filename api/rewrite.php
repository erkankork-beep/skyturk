...
function skyturk_rewrite(array &$news, int $maxItems=30, int $budgetSec=70): array {
  ...
  foreach($news as &$n){
    ...
    if(!empty($o['entity'])&&mb_strlen($o['entity'])<80) $n['entity']=trim($o['entity']);
