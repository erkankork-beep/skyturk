...
switch($name){
 ...
 case 'create_poll':{if(trim($a['question']??'')==='FIKSTUR_CEK'){require_once __DIR__.'/fixtures.php';$r=skyturk_fixtures();logm('MCP fikstur '.json_encode($r));res($id,text($r));}
